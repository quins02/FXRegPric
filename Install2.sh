...
g++ -Wall src/RiskProfile.cpp src/mat_opp.cpp src/opt_eval.cpp src/rng_func.cpp src/download.cpp src/reg_func.cpp -O3 -o FXRegProfile2.exe -std=c++11 -lcurl ${CF}
